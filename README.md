...
### 💼 경력
- 미국 에크론 대학교 고분자공학과 연구교수 (1997)
- 미국 미네소타 대학교 화학공학과 연구교수 (2007)
- 미국 미시시피 주립대학교 물리학과 연구교수 (2014)
...
| Section | Topic | Code |
|---------|--------|------|
| 4.1.1 | Taylor 급수 (exp 함수) | [section_04_01_01_taylor_series_exp.py](./chapter04/section_04_01_01_taylor_series_exp.py) |
